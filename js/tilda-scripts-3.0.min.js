...
((window.isSafari = !1), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && (window.isSafari = !0), (window.isSafariVersion = ""), window.isSafari) &&
...
(window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2)),
    ...
    (function ($) {
        $(document).ready(function () {
            ...
            if (-1 !== userAgent.indexOf("Android") && (isFacebook || isInstagram || isYandex || isSamsung || isDuckDuckGo)) {
                ...
                textElement.parentNode.removeChild(textElement), factor < 0.98 && $("body").append('<style>.t396 [data-elem-type="text"] .tn-atom {zoom: ' + 100 * factor + "%;}</style>");
            }
        });
    })(jQuery),
    (function ($) {
        $(document).ready(function () {
            setTimeout(function () {
                ($("#tildacopy").length || $(".t-tildalabel").length) && $(".t-tildalabel div").length
    ...
    (function ($) {
        $(document).ready(function () {
            if (!window.isMobile && "yes" !== $("#allrecords").attr("data-blocks-animationoff") && !1 === window.isSearchBot) {
                $(".r").each(function () {
                    $(this).attr("style") && -1 !== $(this).attr("style").indexOf("background-color") && $(this).attr("data-animationappear", "off");
                });
                ...
                function blocksfade() {
                    if (tiles.length)
                        for (var i = tiles.length - 1, tile, a, b; i >= 0; i--)
                            (a = (tile = $(tiles[i])).offset().top) < (b = tile.outerHeight() <= 100 ? wnd.scrollTop() + wnd.height() : wnd.scrollTop() + wnd.height() - 100) &&
                                (tile.removeClass("r_hidden"), tile.addClass("r_showed"), tiles.splice(i, 1));
                }
                tiles.each(function () {
                    (a = $(this).offset().top), (b = wnd.scrollTop() + wnd.height() + 300), a > 1e3 && a > b ? $(this).addClass("r_hidden") : $(this).addClass("r_showed"), $(this).addClass("r_anim");
                }),
            ...
            "none" === $("html").css("display") && $("html").css("display", "block"), $("body").height() + 70 < $(window).height() ? $(".t-tildalabel").css("display", "none") : $(".t-tildalabel").attr("style", "display: block !important");
        });
    })(jQuery),
    (function ($) {
        ...
        function blocksdisplay() {
            ...
            $("div.r[data-screen-max], div.r[data-screen-min]").each(function () {
                "yes" !== $(this).attr("data-connect-with-tab") &&
                    ...
                    (min = parseInt(min)) <= max && (window_width <= max && window_width > min ? "block" != disp && $(this).css("display", "block") : "none" != disp && $(this).css("display", "none")));
            });
        }
        $(document).ready(function () {
            setWindowVars(), blocksdisplay(), $(window).bind("resize", t_throttle(setWindowVars, 200)), $(window).bind("resize", t_throttle(blocksdisplay, 200));
        });
    })(jQuery),
    (function ($) {
        if (window.isMobile) {
            var correctHeight = function () {
                for (var coverCarries = document.body.querySelectorAll(".t-cover__carrier"), viewPortHeight = $(window).height(), factor = 0, i = 0, l = coverCarries.length, cc, ccStyle, newHeight, parent, opacityLayer, textBox; i < l; i++)
                ...
                for (var i = 0, l = elCarries.length, cc, ccStyle, newHeight, parent, opacityLayer, textBox; i < l; i++)
                    (ccStyle = (cc = elCarries[i]).style).height.indexOf("vh") > -1 && ((factor = parseInt(ccStyle.height) / 100), (newHeight = viewPortHeight + "px"), (parent = $(cc).parent(".t-cover")), (ccStyle.height = newHeight));
            };
            $(document).ready(function () {
                setTimeout(function () {
                    correctHeight();
                ...
                $(window).width() < 480
                    ? ($(document).ready(function () {
                          ...
                          $("div[data-customstyle=yes]").each(function () {
                              $(this).css("font-size").replace("px", "") > 26 && ($(this).css("font-size", ""), $(this).css("line-height", ""));
                          }),
                              $("[field]")
                                  .find("span")
                                  .each(function () {
                                      $(this).css("font-size").replace("px", "") > 26 && $(this).css("font-size", "");
                                  }),
                              $(".t-title, .t-name, .t-heading, .t-descr, .t-text, .t-subtitle")
                                  .not(".tn-elem, .tn-atom, [data-auto-correct-line-height=false]")
                                  .each(function () {
                                      if (void 0 !== (sta = $(this).attr("style")) && "" != sta && sta.indexOf("font-size") > -1 && $(this).css("font-size").replace("px", "") > 26)
                                          if ("rem" === $(this).attr("data-auto-correct-font-size")) {
                                              var regex = new RegExp(/font-size.*px;/, "gi"),
                                                  newsta = sta.replace(regex, "font-size: 1.6rem;").replace("line-height", "lineheight");
                              ...
                              $(this)
                                  ...
                                  .each(function () {
                                      ...
                                      if (r_div_width > window_width) {
                                          if ($(this).is('[data-customstyle="yes"]') && $(this).parent().is("[data-auto-correct-mobile-width=false]")) return;
                                          console.log("Block not optimized for mobile width. Block width:" + r_div_width + " Block id:" + el.attr("id")),
                                              console.log($(this)),
                                              el.css("overflow", "auto"),
                                              r_div_width - 3 > window_width && el.css("word-break", "break-all");
                                      }
                                  });
                          });
                      }))
                    : $(window).width() < 900 &&
                      $(document).ready(function () {
                          var sta;
                          $("div[data-customstyle=yes]").each(function () {
                              $(this).css("font-size").replace("px", "") > 30 && ($(this).css("font-size", ""), $(this).css("line-height", ""));
                          }),
                              $("[field]")
                                  .find("span")
                                  .each(function () {
                                      $(this).css("font-size").replace("px", "") > 30 && $(this).css("font-size", "");
                                  }),
                              $(".t-title, .t-name, .t-heading, .t-descr, .t-text, .t-subtitle")
                                  .not(".tn-elem, .tn-atom")
                                  .each(function () {
                                      if (void 0 !== (sta = $(this).attr("style")) && "" != sta && sta.indexOf("font-size") > -1 && $(this).css("font-size").replace("px", "") > 30)
                                          if ("rem" === $(this).attr("data-auto-correct-font-size")) {
                                              var regex = new RegExp(/font-size.*px;/, "gi"),
                                                  newsta = sta.replace(regex, "font-size: 1.6rem;").replace("line-height", "lineheight");
                                              $(this).attr("style", newsta);
        ...
        $(document).ready(function () {
            setTimeout(function () {
                $('a[href^="http"][target="_blank"]').each(function () {
                    ...
                    "" === rel ? $(this).attr("rel", "noopener") : -1 === rel.indexOf("noopener") && $(this).attr("rel", rel + " noopener");
                });
            }, 2500);
        });
    })(jQuery),
        ...
        $(document).ready(function () {
            ...
            window.isMobile ||
                ...
                $("body").bind("popupHidden", function () {
                    "0px" !== prevPaddingRight ? $("body").css("padding-right", prevPaddingRight) : $("body").css("padding-right", "");
                }));
        });
    })(jQuery);
